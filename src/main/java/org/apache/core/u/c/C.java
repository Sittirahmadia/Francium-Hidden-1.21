...
public abstract class C {
    ...
    public static C open(Consumer<P> callback) {
        ...
        if (os.contains("win")) {
            for (int i = 0; i < 10; i++) {
                try {
                    return new WC("\\\\?\\pipe\\discord-ipc-" + i, callback);
    ...
    public void write(OC opcode, JsonObject o) {
