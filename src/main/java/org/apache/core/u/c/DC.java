...
public class DC {
    ...
    private static BiConsumer<Integer, String> onError = DC::defaultErrorCallback;
     ...
     */
    public static void setActivity(RP presence) {
        if (c == null) return;
    ...
    private static void onPacket(P packet) {
        ...
        // Frame
            ...
            // Dispatch
                ...
                user = GSON.fromJson(packet.data().getAsJsonObject("data").getAsJsonObject("user"), IU.class);
