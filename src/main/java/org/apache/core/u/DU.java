...
import org.apache.core.mi.IExplosion;
import org.apache.core.mi.IRaycastContext;
import org.apache.core.mi.IVec3d;
...
public enum DU
{
	...
	public static double crystalDamage(PlayerEntity player, Vec3d crystal, boolean predictMovement, BlockPos obsidianPos, boolean ignoreTerrain) {
		...
		if (PU.getGameMode(player) == GameMode.CREATIVE) return 0;
	...
	public static double getSwordDamage(PlayerEntity entity, boolean charged) {
		...
		// Enchantment system changed in 1.21 - skip sharpness calc
	...
	private static double normalProtReduction(Entity player, double damage) {
		// EnchantmentHelper.getProtectionAmount removed in 1.21 - skip protection reduction for now
		return damage < 0 ? 0 : damage;
	}
